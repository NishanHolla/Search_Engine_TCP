...
answ = ["PESU ECC ","Computer Networks","Apple","Cholebature","carrot","dominos","cool joint","nice to meet you","Nishan Neeraj Nishank","TCP UDP","HTTP FTP SMTP ","IP","NNN ","SUNSILK","DR ANNAPURNA","NANDINI","CornerHouse","MTR","Meghana's","transport layer protocol","user datagram protocol","mcdonald's","BJP","Narendra Modi"]
